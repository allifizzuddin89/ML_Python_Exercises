...
result = 100/77
fav = "suka"
print("\nTHE RESULT IS {r:2.4f} AND FEEL {s}".format(r=result, s=fav))
...
def fib(n):
    ...
    while a < n:
        print(a,end = ' ')
        a, b = b, a+b # temp = a,a=b,b=b+a(b+=a) same as b+=temp
    print()
